...
const HOME_KEYWORDS = [
  ...
  'wholesale jewellery',
  'wholesale artificial jewellery',
  'wholesale jewellery manufacturer india',
  'fashion jewellery',
  'imitation jewellery',
  ...
  'necklace set',
  'wholesale necklace',
  'artificial necklace manufacturer',
  'oxidised jewellery',
  'oxidised jewellery manufacturer',
  'gold plated jewellery',
  'gold plated jewellery manufacturer',
  ...
  'fashion accessories',
  'women jewellery',
  'bangles manufacturer',
  'artificial bangles',
  'jewellery wholesale india',
  'reshmi qureshi jewellery',
  'reshmi qureshi wholesale',
  'wholesalejewelryressham',
  'jewellery manufacturer mumbai',
  'jewellery supplier mumbai',
  'wholesale jewellery mumbai',
  'mumbai jewellery manufacturer',
  'maharashtra jewellery manufacturer',
  'india jewellery exporter',
  'bulk order jewellery',
  'minimum order jewellery',
  ...
  'jewellery set manufacturer',
  'wholesale jewellery set',
  'jhumka earrings',
  'chandbali earrings',
  'statement jewellery',
  ...
  'cheap jewellery wholesale',
  'jewellery at wholesale price',
  'bulk purchase jewellery',
  'b2b jewellery supplier',
  'b2b jewellery manufacturer',
  'reseller jewellery',
  'jewellery reseller',
  'dropship jewellery india',
  'export quality jewellery',
  'export quality artificial jewellery',
  'jewellery export india',
  'international jewellery supplier',
  'global jewellery supplier',
  'worldwide jewellery delivery',
  'rings manufacturer india',
  'bracelets manufacturer india',
  'maang tikka manufacturer',
  'haar set manufacturer',
  'choker necklace manufacturer',
  'long necklace manufacturer',
  'layered necklace manufacturer',
  'mala manufacturer india',
  'bangle set manufacturer',
  'kada manufacturer india',
  'fashion ring manufacturer',
  'toe ring manufacturer',
  'anklet manufacturer india',
  'nose pin manufacturer',
  'maangtika wholesale',
  'jewellery for boutique',
  'boutique jewellery supplier',
  'jewellery for retailers',
  'wholesale for retailers india',
].join(', ');
